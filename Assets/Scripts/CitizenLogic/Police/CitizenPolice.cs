...
{
    [RequireComponent(typeof(PolicemanHealth))]
    [RequireComponent(typeof(StateMachineCitizen))]
    public class CitizenPolice : Citizen
    {
        private PolicemanHealth _health;
